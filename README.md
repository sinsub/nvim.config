...
My neovim config, derived from: https://github.com/nvim-lua/kickstart.nvim
...
- on Linux and Mac
```sh
git clone https://github.com/sinsub/nvim.config.git "${XDG_CONFIG_HOME:-$HOME/.config}"/nvim
```
